...
public partial class vw_Idx_Industry
{
    ...
    public string? Show_Business_Address { get; set; }

    public string? Show_Reg_Address { get; set; }
    ...
    public string? CTRORG_Name { get; set; }

    public string? ORG_Name { get; set; }

    public string? ModUserName { get; set; }

    public string? WaterCityName { get; set; }

    public string? WaterCountyName { get; set; }

    public string? Create_Time_Show { get; set; }

    public string? Update_Time_Show { get; set; }

    public string? NCHKDATE_Show { get; set; }

    public string? WaterTypeName { get; set; }

    public string? Product_Main_Name { get; set; }

    public string? Product_Sub_Name { get; set; }

    public string? Product_Third_Name { get; set; }
    ...
    public string? Cook_Licenses_Show { get; set; }

    public string? Show_PRODUCT_INSURANCE { get; set; }

    public string? INSURANCE_SDATE_Show { get; set; }

    public string? INSURANCE_EDATE_Show { get; set; }
