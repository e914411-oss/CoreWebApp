...
public partial class 檢視_索引_具結先行放行_主表_申請運往地點表2
{
    ...
    public string? 檢驗日期_索引 { get; set; }

    public string? 檢驗日期_展示 { get; set; }
    ...
    public string? 申請運往地點_備註 { get; set; }

    public string? 運往地址 { get; set; }
    ...
    public string? 封存回報日期 { get; set; }

    public string? 封存情形備註 { get; set; }

    public string? 銷毀退運情形回報 { get; set; }

    public string? 銷毀退運回報日期 { get; set; }

    public string? 銷毀退運備註 { get; set; }
}
