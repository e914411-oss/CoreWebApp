...
public partial class 檢視_收尋_明細_紀錄_GHP
{
    ...
    public string? 主分類名稱 { get; set; }

    public string? 次分類名稱 { get; set; }

    public string? 次分類主鍵 { get; set; }

    public string? 主分類主鍵 { get; set; }
    ...
    public string? FMS介接主鍵_稽查事件主表 { get; set; }
