...
public partial class 檢視_索引_查驗登記產品查核明細表
{
    ...
    public string? 查核項目 { get; set; }

    public string? 查核項目_1 { get; set; }

    public string? 查核項目_2 { get; set; }

    public string? 查核項目_3 { get; set; }

    public string? 查核項目_4 { get; set; }
    ...
    public string? 查驗登記產品_檢驗 { get; set; }
