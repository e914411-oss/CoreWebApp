...
public partial class vw_Lunch_Box
{
    public int Lunch_Box_ID { get; set; }

    public string? Lunch_Box_Name { get; set; }

    public string? Lunch_Box_Person { get; set; }

    public string? Lunch_Box_Tel { get; set; }

    public string? Lunch_Box_Address2 { get; set; }

    public string? Lunch_Box_Address { get; set; }

    public string? Lunch_Box_CityID { get; set; }
    ...
    public DateTime? Create_ROC_Time { get; set; }
