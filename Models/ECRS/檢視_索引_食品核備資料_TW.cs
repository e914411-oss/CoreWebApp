...
public partial class 檢視_索引_食品核備資料_TW
{
    ...
    public string? 建立日期_索引 { get; set; }

    public string? 到期日期_索引 { get; set; }

    public string? 建立日期_國曆 { get; set; }

    public string? 到期日期_國曆 { get; set; }
