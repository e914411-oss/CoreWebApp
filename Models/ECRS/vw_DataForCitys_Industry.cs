...
public partial class vw_DataForCitys_Industry
{
    ...
    public DateTime? Expr43 { get; set; }

    public string? Expr44 { get; set; }

    public string? Expr45 { get; set; }

    public DateTime? Expr46 { get; set; }

    public DateTime? Expr47 { get; set; }
    ...
    public DateTime? Expr52 { get; set; }

    public int? Expr53 { get; set; }
    ...
    public DateTime? Expr74 { get; set; }

    public string? Expr75 { get; set; }

    public DateTime? Expr76 { get; set; }

    public string? Expr77 { get; set; }

    public bool? Expr78 { get; set; }
