...
public partial class Trans_FTR_PLACE_PMDS_ONLINE_bak
{
    ...
    public string? GOODS_ST_CITY_PMDS_ONLINE { get; set; }

    public string? GOODS_ST_CITY_Name_PMDS_ONLINE { get; set; }
}
